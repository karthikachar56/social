  ...
  return (
    <div className="min-h-screen bg-[#0F0F1A] text-[#E2E8F0]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        {/* HERO NEWS CARD */}
        <article className="glass rounded-2xl overflow-hidden shadow-2xl border border-pink-500/10">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            {news.summary && (
              <p className="text-slate-400 text-sm sm:text-base border-l-2 border-pink-500 pl-4 py-1.5 italic bg-[#16162A]/20">
                {news.summary}
              </p>
            )}
            ...
            <div className="pt-6 border-t border-[#2A2A4A]/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3 text-xs sm:text-sm text-slate-500">
                ...
                <div>
                  <p className="font-bold text-slate-300">{news.adminName}</p>
              ...
              <div className="flex items-center gap-2">
                <button 
                  className={`action-btn px-4 py-2 border border-[#2A2A4A] rounded-xl hover:border-rose-500/50 ${
                    isLiked(news._id) ? 'liked' : 'text-slate-400'
                  }`}
                  onClick={handleLike}
                >
                ...
                <button className="action-btn text-slate-400 hover:text-purple-400 border border-[#2A2A4A] px-3.5 py-2 rounded-xl" onClick={downloadNews} title="Download text info">
                  <Download className="w-4 h-4" />
                </button>

                <button className="action-btn text-slate-400 hover:text-green-400 border border-[#2A2A4A] px-3.5 py-2 rounded-xl" onClick={shareNews} title="Share Link">
        ...
        {/* COMMENTS SECTION */}
        <section className="glass rounded-2xl p-6 sm:p-8 space-y-6 border border-pink-500/10 shadow-xl">
            ...
            <form onSubmit={postComment} className="flex gap-3">
              ...
              <div className="flex-grow relative">
                ...
                <button 
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1.5 rounded-lg text-pink-400 hover:text-white hover:bg-pink-900/40 transition disabled:opacity-40"
                >
