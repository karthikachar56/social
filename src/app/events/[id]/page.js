      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <article className="glass rounded-2xl overflow-hidden shadow-2xl border border-purple-500/10">
          ...
          <div className="p-6 sm:p-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-slate-100/50 p-4 rounded-xl border border-slate-200/50 text-sm">
              {event.date && (
            ...
            <div className="pt-6 border-t border-slate-200/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3 text-xs sm:text-sm text-slate-500">
                ...
                <div>
                  <p className="font-bold text-slate-600">{event.adminName}</p>
              ...
              <div className="flex items-center gap-2">
                <button 
                  className={`action-btn px-4 py-2 border border-slate-200 rounded-xl hover:border-rose-500/50 ${
                    isLiked(event._id) ? 'liked' : 'text-slate-500'
                  }`}
                  onClick={handleLike}
                >
                ...
                <button className="action-btn text-slate-500 hover:text-purple-400 border border-slate-200 px-3.5 py-2 rounded-xl" onClick={downloadEvent} title="Download text info">
                  <Download className="w-4 h-4" />
                </button>

                <button className="action-btn text-slate-500 hover:text-green-400 border border-slate-200 px-3.5 py-2 rounded-xl" onClick={shareEvent} title="Share Link">
