@echo off
title EventHub Local Admin App Test Runner
echo ===================================================
echo Starting and Running EventHub Admin App on Emulator
echo ===================================================
...
set APK_PATH="public\eventhub-admin.apk"
...
%ADB_PATH% shell am start -n com.example.eventhubadmin/com.example.eventhubadmin.MainActivity
if %ERRORLEVEL% neq 0 (
...
echo ===================================================
echo Success! Admin App is running.
echo ===================================================
pause
